...
// will only see deployed updates on subsequent visits to a page, after balance the
...
export function register(config) {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    // The URL constructor is available in balance browsers that support SW.
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              // content until balance client tabs are closed.
              console.log(
                'New content is available and will be used when balance ' +
